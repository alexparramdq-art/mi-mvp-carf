...
function PrimaryButton({ children, onClick, saved }) {
  return (
    <button
      onClick={onClick}
      style={{
...
// =====================================================================
function HomeScreen({ players, onOpenPlayer, onNewPlayer, onOpenMetodo, onOpenFamilias, loading, isCoach, canWrite, subscriptionStatus, userId, userEmail }) {
...
const catAccent = { "Físico": c.celeste, "Técnico": c.yellow, "Cognitivo": c.orange, "Táctico": c.red, "Partido": c.correct };
...
function EstadisticasScreen({ entries, onBack }) {
  ...
  const { result, sessionCount, partidoCount, sesionCorrect, sesionFailed, partidoCorrect, partidoFailed } = aggregateStats(entries, periodo, lugarFiltro);
